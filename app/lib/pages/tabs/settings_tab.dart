  ...
  Widget build(BuildContext context) {
    return ViewModelBuilder(
      ...
      builder: (context, vm) {
        ...
        // Use iOS-style settings layout on all widths by default.
          ...
          return Theme(
            ...
            child: Align(
              ...
              child: ConstrainedBox(
                constraints: BoxConstraints(maxWidth: width >= 1000 ? 760 : double.infinity),
                      ...
                      children: [
                        ...
                        if (checkPlatform([TargetPlatform.windows])) ...[
                          ...
                          _SettingsEntry(
                            ...
                            child: CustomDropdownButton<WindowsVideoConversionMode>(
                              value: vm.settings.windowsVideoConversionMode,
                              items: WindowsVideoConversionMode.values.map((mode) {
                                return DropdownMenuItem(
                                  value: mode,
                                  alignment: Alignment.center,
                                  child: Text(_windowsVideoModeLabelDesktop(mode)),
                                );
                              }).toList(),
                              onChanged: (mode) async {
                                await ref.notifier(settingsProvider).setWindowsVideoConversionMode(mode);
                              },
                            ),
                          ),
                          _ButtonEntry(
                            label: t.settingsTab.receive.windowsIosCompat.ffmpegPath,
                            buttonLabel: vm.settings.ffmpegCustomPath != null && vm.settings.ffmpegCustomPath!.isNotEmpty
                                ? p.basename(vm.settings.ffmpegCustomPath!)
                                : t.settingsTab.receive.windowsIosCompat.browseFfmpeg,
                            onTap: () async {
                          ...
                          _SettingsEntry(
                            label: t.settingsTab.receive.windowsIosCompat.codecHintsTitle,
                            child: Column(
                      ...
                      child: SafeArea(
                        child: Container(
                          ...
                          child: Padding(
                            ...
                            child: Text(
                              t.settingsTab.title,
                              style: Theme.of(context).textTheme.titleLarge?.copyWith(color: IosStyle.text),
                              textAlign: TextAlign.center,
                            ),
                          ),
                        ),
...
String _windowsVideoModeLabelDesktop(WindowsVideoConversionMode mode) {
  switch (mode) {
