...
class _TranslationsReceiveOptionsPageFr extends TranslationsReceiveOptionsPageEn {
  ...
  @override
  String get appDirectory => '(dossier WinDrop)';
  @override
...
class _TranslationsWebSharePageFr extends TranslationsWebSharePageEn {
  ...
  @override
  String get encryptionHint => 'WinDrop utilise un certificat auto-signé. Vous devez l\'accepter dans le navigateur.';
  @override
...
class _TranslationsAboutPageFr extends TranslationsAboutPageEn {
  ...
  // Translations
  @override
  String get title => 'À propos de WinDrop';
  @override
  List<String> get description => [
    'WinDrop est un logiciel gratuit et open-source qui vous permet de partager de manière sécurisée des fichiers et des messages avec d\'autres appareils connectés à votre réseau local. Une connexion à internet n\'est pas requise.',
    'WinDrop est disponible sur Android, iOS, macOS, Windows et Linux. Vous pouvez accéder à ces téléchargements depuis la page officielle.',
  ];
  @override
...
class _TranslationsDonationPageFr extends TranslationsDonationPageEn {
  ...
  @override
  String get info =>
      'WinDrop est gratuit, open-source et sans aucune pub. Si vous aimez ce logiciel, vous pouvez faire un don pour soutenir son développement.';
  @override
...
class _TranslationsTrayFr extends TranslationsTrayEn {
  ...
  @override
  String get close => 'Quitter WinDrop';
  @override
...
class _TranslationsNetworkInterfacesPageFr extends TranslationsNetworkInterfacesPageEn {
  ...
  @override
  String get info =>
      'Par défaut, WinDrop utilise toutes les interfaces réseau disponibles. Vous pouvez exclure les réseaux indésirables ici. Vous aurez besoin de redémarrer le serveur pour appliquer les changements.';
  @override
  String get preview => 'Aperçu';
  @override
...
class _TranslationsSettingsTabGeneralFr extends TranslationsSettingsTabGeneralEn {
  ...
  @override
  String get launchAtStartup => 'Lancer WinDrop à la connexion de l\'utilisateur';
  @override
  String get launchMinimized => 'Minimiser WinDrop lors du lancement';
  @override
  String get showInContextMenu => 'Afficher WinDrop dans le menu contextuel';
  @override
...
class _TranslationsSettingsTabOtherFr extends TranslationsSettingsTabOtherEn {
  ...
  @override
  String get support => 'Soutenir WinDrop';
  @override
...
class _TranslationsDialogsLocalNetworkUnauthorizedFr extends TranslationsDialogsLocalNetworkUnauthorizedEn {
  ...
  String get description =>
      'WinDrop ne peut pas trouver d\'autres appareils sans la permission de scanner votre réseau local. Veuillez donner cette permission à WinDrop dans les paramètres système.';
  @override
...
class _TranslationsDialogsNoPermissionFr extends TranslationsDialogsNoPermissionEn {
  ...
  // Translations
  @override
  String get title => 'WinDrop n\'a pas la permission';
  @override
...
class _TranslationsDialogsSendModeHelpFr extends TranslationsDialogsSendModeHelpEn {
  ...
  @override
  String get link =>
      'Les destinataires n\'ayant pas WinDrop installé peuvent télécharger les fichiers sélectionnés en ouvrant le lien dans leur navigateur.';
}
